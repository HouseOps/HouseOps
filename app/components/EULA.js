          ...
          <div className="pt-dialog-body">
            ...
            <div style={{ height: '600px' }}>
              <Scrollbars>
                ...
                <br />
                <h3>Terms:</h3>
                <p><b>1.</b> This program will never send to external location your personal data or any other sensitive data.</p>
                <p><b>2.</b> This program uses Google Analytics to monitor the number of queries executed, the pages viewed and the location where this program is being used, just for improvements to this program.</p>
                <p><b>3.</b> This program is community-based and is open-source, analyze the code of this program before using it to see if it is compatible with your needs.</p>
                <p><b>4.</b> You are completely responsible for everything that happens in this program. HouseOps does not execute anything without the user's permission, all actions are done manually by the operator.</p>
                <p><b>5.</b> You is responsible for any loss of data or any other loss that you or your business suffer from using this program.</p>
                <p><b>6.</b> You are completely responsible for everything that happens or for all use of this program.</p>
                <p><b>7.</b> You agree to all the terms of the external modules used by this program.</p>
